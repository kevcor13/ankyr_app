        ...
        <div className="post_details-conatiner">
            {isPending? <Loader /> : (
                <div className="post_details-card">
                    ...
                    alt="creator"
                    className="rounded-full w-8 lg:h-8 lg:w-12 h-12"/>
                    ...
                    <div className="flex-center">
                        ...
                        <Button onClick={handleDeletePost} variant="ghost" className={`${user.id !== post?.creator.$id && 'hidden'}`}>
                            <img src="/assets/icons/delete.svg" alt="delete" width={24} height={24} />
                        </Button>
                    </div>
                    </div>

                    <hr className="border w-full boder-dark-4/80"/>
